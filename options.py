...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--train_reference_type', type=str, default='full', help='Full Reference: full, Blurred Reference: blur, No Reference: no')
        parser.add_argument('--val_reference_type', type=str, default='full', help='Full Reference: full, Blurred Reference: blur, No Reference: no')
        
        parser.add_argument('--use_masked_loss_val', type=bool, default=True, help='Loss is calculated only on glass region, default=True')
        ...
        # args for training
        parser.add_argument('--img_width', type=int, default=512, help='patch size of training sample')
        parser.add_argument('--img_height', type=int, default=256, help='patch size of training sample')
        ...
        parser.add_argument('--real_dir', type=str, default ='./datasets/SIDD/val',  help='dir of train data')
