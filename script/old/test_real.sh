...
python3 test/test_pano_vis_real.py --arch Uformer_B_noshift_nomodulator --gpus 8 --input_dir /root/dataset/ReflectionRemoval/ECCV22_Real_NR --result_dir ./results/vis_real/ --weights /root/workplace/results/uniclus/motiondeblur/Syn80000/Uformer_B_noshift_nomodulator_AttnVis/models/model_best_e10.pth 
